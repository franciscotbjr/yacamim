/**
 * YGetSimpleAsyncHttpRestWithContext.java
 *
 * Copyright 2014 yacamim.org.br
 *
 ...
 */
public class YGetSimpleAsyncHttpRestWithContext extends AsyncTask<YSimpleHttpRestRequestAdpater, Void, YSimpleHttpResponseAdapter> {
	
	private static final String UTF_8 = "UTF-8";

	private static final String APPLICATION_JSON = "application/json";

	private static final String TAG = YGetSimpleAsyncHttpRestWithContext.class.getSimpleName();
	 ...
	 */
	public YGetSimpleAsyncHttpRestWithContext(final Context context, 
