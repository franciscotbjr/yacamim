 ...
 */
public class YPostSimpleAsyncHttpRest extends YBaseAsyncTask<YSimpleHttpRestRequestAdpater, YSimpleHttpResponseAdapter> {
	
	private static final String UTF_8 = "UTF-8";

	private static final String APPLICATION_JSON = "application/json";

	private static final String TAG = YPostSimpleAsyncHttpRest.class.getSimpleName();
	 ...
	 */
	public YPostSimpleAsyncHttpRest(final Activity activity, 
	...
	protected YSimpleHttpResponseAdapter doRest(YSimpleHttpRestRequestAdpater... ySimpleHttpRestRequestAdpater) {
		try {
            ...
            final HttpPost post = new HttpPost(this.ySimpleHttpRestRequestAdpater.getUri());
