...
import br.org.yacamim.relationship.mapping.defaults.unidirectionalSingleValuedRelationships.entity.Address;
import br.org.yacamim.relationship.mapping.defaults.unidirectionalSingleValuedRelationships.entity.Employee;
import br.org.yacamim.relationship.mapping.defaults.unidirectionalSingleValuedRelationships.entity.TravelProfile;
...
public class InsertEmployeeActivity extends YBaseListActivity {
	...
	protected void init() {
		try {
			...
			final TravelProfile travelProfile = new TravelProfile();
			travelProfile.setName("Profile 1");
			
			final Employee employee = new Employee();
			employee.setAddress(address);
			employee.setProfile(travelProfile);
