 ...
 */
@Entity
@Table(name="Cubicle_boor")
public class Cubicle extends YBaseEntity {
	 ...
	 * @param parcel
	 */
	public Cubicle(final Parcel parcel) {
		super(parcel);
	}
	 ...
	 * 
	 */
	public static final Parcelable.Creator<Cubicle> CREATOR = new Parcelable.Creator<Cubicle>() {
        public Cubicle createFromParcel(Parcel pc) {
            return new Cubicle(pc);
        }
        public Cubicle[] newArray(int size) {
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((residentEmployee == null) ? 0 : residentEmployee.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (name == null) {
			...
			return false;
		if (residentEmployee == null) {
			if (other.residentEmployee != null)
				return false;
		} else if (!residentEmployee.equals(other.residentEmployee))
			return false;
		return true;
	}
