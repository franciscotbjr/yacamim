...
/**
 * Classe UpdateEmployeeActivity TODO
 *
...
public class UpdateEmployeeActivity extends YBaseListActivity {
	...
	protected void init() {
		try {
			...
			Date now = new Date();
			employee.setName(now.toString());
			Cubicle cubicle = employee.getAssignedCubicle();
			cubicle.setName("Cubicle " + now.toString());
