 ...
 * @since 1.0
 */
public class Home_UnidirectionalMultiValuedActivity extends YBaseActivity {
	
	private static final String TAG = Home_UnidirectionalMultiValuedActivity.class.getSimpleName();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_home_unidirectional_multi_valued);
	}
