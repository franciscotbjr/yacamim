...
/**
 * Classe InsertDepartmentActivity TODO
 *
 * @author yacamim.org.br (Francisco Tarcizo Bomfim Júnior)
 * @version 1.0
 * @since 1.0
 */
public class InsertDepartmentActivity extends YBaseListActivity {
	
	private static final String TAG = InsertDepartmentActivity.class.getSimpleName();
	...
	protected void init() {
		try {
			...
			defaultDBAdapter.insert(newDepartment);
			Department department = defaultDBAdapter.getByID(newDepartment.getId());
