 ...
 * @since 1.0
 */
public class YRelationshipMappingDefaultsApplication extends YApplication {
	
	private static final String TAG = YRelationshipMappingDefaultsApplication.class.getSimpleName();

	/**
	 * 
	 */
	public YRelationshipMappingDefaultsApplication() {
		super();
	}
