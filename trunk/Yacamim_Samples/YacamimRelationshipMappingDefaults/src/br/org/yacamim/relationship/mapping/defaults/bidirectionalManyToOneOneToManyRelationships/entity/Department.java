 ...
 */
package br.org.yacamim.relationship.mapping.defaults.bidirectionalManyToOneOneToManyRelationships.entity;
 ...
 */
@Entity
@Table(name="Department_bmoomr")
public class Department extends YBaseEntity {
	 ...
	 * @param parcel
	 */
	public Department(final Parcel parcel) {
		super(parcel);
	}
	...
	public static final Parcelable.Creator<Department> CREATOR = new Parcelable.Creator<Department>() {
        public Department createFromParcel(Parcel pc) {
            return new Department(pc);
        }
